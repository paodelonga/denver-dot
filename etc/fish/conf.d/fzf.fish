...
export FZF_DEFAULT_COMMAND="fdfind --type file --type directory --hidden --follow --no-ignore-vcs -E 'node_modules' -E '.git'"

export FZF_ALT_C_COMMAND="fdfind --type directory --hidden --follow --no-ignore-vcs -E 'node_modules' -E '.git'"
export FZF_CTRL_T_COMMAND="fdfind --hidden --follow --no-ignore-vcs -E 'node_modules' -E '.git'"
